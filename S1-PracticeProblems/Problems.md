...
**1.** Solve for $x$: $\dfrac{2x - 3}{x + 1} = \dfrac{x + 5}{x - 2}$
...
**8.** Differentiate: $f(x) = 4x^5 - \dfrac{3}{x^2} + \sqrt{x} - 7$
...
**11.** Find $\dfrac{dy}{dx}$: $\quad y = x^3 \ln(x) - e^{2x}\sin(x)$
...
**14.** Find $\dfrac{dy}{dx}$: $\quad x^2 y + y^3 = 6$
